...
class GamePlay extends Phaser.Scene{
    ...
    preload() {
        this.load.image('enemy-green', 'assets/asteroid.png');
        ...
        this.load.image('background', '../assets/alt-background-1.jpg');
        this.load.image('bullet', 'assets/red-bullet.gif');
        this.load.image('enemy-blue', 'assets/alien-ship.png');
    ...
    create() {
        ...
        gamePlay.blueEnemyBullets = game.add.group();
        ...
        //  The boss
        gamePlay.boss = game.add.sprite(0, 0, 'boss');
        boss.exists = false;
        boss.alive = false;
        ...
        //  boss's boosters
        gamePlay.booster = game.add.emitter(boss.body.x, boss.body.y - boss.height / 2);
        booster.width = 0;
        ...
        gamePlay.bossDeath = game.add.emitter(boss.x, boss.y);
    ...
    update() {
        ...
        if (! player.alive && gameOver.visible === false) {
            ...
            function setResetHandlers() {
                ...
                gamePlay.tapRestart = game.input.onTap.addOnce(_restart,this);
                gamePlay.spaceRestart = fireButton.onDown.addOnce(_restart,this);
                function _restart() {
                    tapRestart.detach();
                    spaceRestart.detach();
                    restart();
